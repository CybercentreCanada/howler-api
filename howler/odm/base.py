...
from howler.common.exceptions import (HowlerKeyError,
                                      ...
                                      HowlerTypeError, HowlerValueError)
    ...
    def markdown(cls, toc_depth=1, defaults=None) -> Union[str, Dict]:
        ...
        for field, info in cls.fields().items():
            ...
            if (
                ...
                and field_class.__module__ == cls.__module__
            ):
                model_deps.append(
                    field_class.markdown(toc_depth=toc_depth + 1, defaults=info.default)
                )
